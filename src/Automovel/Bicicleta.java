...
import java.util.Locale; // serve para utilizar o Locale.US
...
public class Bicicleta extends Automotor {
    ...
    public Bicicleta(String modelo, int anoFabricacao, String montadora, String cor, double kilometragem,
        ...
        if (quantidadeMarchas <= 0) {
            ...
            throw new IllegalArgumentException("A quantidade de marchas tem que ser valida.");
        }
    ...
    //  função auxiliar para tratar strings e evitar conflitos com aspas simples
